...
<div class="box">
    <div class="breadcrumb-wrap">
        <a-breadcrumb style="border-bottom: 1px doshed #e5e5e5">
            ...
            <a-breadcrumb-item> OAI采集 </a-breadcrumb-item>
        </a-breadcrumb>
    </div>
    <!-- 表单 -->
    <div class="wrap">
        ...
        <a-form-model-item  label="收割接口地址" prop="query">
            <a-input v-model="form.query"  size="large" type="text" placeholder="收割接口地址">
            </a-input>
        </a-form-model-item>
    ...
    methods: {
        handleSubmit() {
            this.$refs.ruleForm.validate(valid => {
                if (valid) {
                    acqData('/dp-collection/oai/grab', this.form)
                        .then(res => {
                            console.log(res);
                        }).catch(err => {
                            console.log(err);
